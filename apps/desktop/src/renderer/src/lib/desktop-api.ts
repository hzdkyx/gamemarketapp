...
const fallbackApi: HzdKyxDesktopApi = {
  ...
  auth: {
    ...
    listLocalRecoveryUsers: async () => [],
    resetLocalPassword: unavailable,
  },
  users: {
    list: async () => [],
    create: unavailable,
  ...
  cloudSync: {
    ...
    updateWorkspaceMember: unavailable,
    disableWorkspaceMember: unavailable,
    enableWorkspaceMember: unavailable,
    removeWorkspaceMember: unavailable,
    resetWorkspaceMemberPassword: unavailable,
    listWorkspaceMemberAudit: async () => [],
