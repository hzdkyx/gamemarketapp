...
const eventLabels: Record<EventType, string> = {
  ...
  "audit.product_updated": "Histórico de produto",
  "audit.variant_updated": "Histórico de variação",
  "audit.inventory_updated": "Histórico de estoque",
  "audit.order_updated": "Histórico de pedido",
  "audit.order_status_changed": "Histórico de status do pedido",
  "audit.entity_history_recorded": "Histórico auditável",
